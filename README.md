...
- Invalid IdamRole 'caseworker-publiclaw-doesnotexist' in AuthorisationCaseField tab, case type 'Adoption', case field 'submitterId', crud 'CRUD'
```

Then the indicated role, here `caseworker-publiclaw-doesnotexist`, must be added to CCD (See [2. Add roles](#2-add-roles)).
